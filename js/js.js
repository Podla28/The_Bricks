...
*/
  ...
  function draw() {
	...
	if(dy==0){
			...
			ctx.strokeStyle = "#0E4D2B";
			ctx.fillStyle = "black";
			ctx.fillText("Pritisni SPACE",130,350);
			//ctx.strokeText("Press SPACE to play",50,350);
...
function Zmaga(){
  Swal.fire({
type: 'success',
html:'<p style="font-family:Courier New;font-size:50px;color:black;">Zmaga</p><br/>',
}).then(function(isConfirm) {
if (isConfirm) {
location.reload();
}
